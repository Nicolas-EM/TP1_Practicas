...
public enum Level {
	...
	private Level(int length, int width, int visibility, double obstacleFrequency, double coinFrequency, double advancedObjectF) {
		this.length = length;
		this.width = width;
		this.visibility = visibility;
		this.obstacleFrequency = obstacleFrequency;
		this.coinFrequency = coinFrequency;
		this.advancedObjectFrequency = advancedObjectF;
	}
	...
	public boolean hasAdvancedObjects() {
		return this.advancedObjectFrequency != 0;
	}

	public double advancedObjectsFrequency() {
		return this.advancedObjectFrequency;
	}
}
